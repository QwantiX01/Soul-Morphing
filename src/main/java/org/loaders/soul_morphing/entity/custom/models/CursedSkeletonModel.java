...
public class CursedSkeletonModel<T extends CursedSkeletonRenderState> extends EntityModel<T> {
  public static final ModelLayerLocation LAYER_LOCATION =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(MODID, "cursed_skeleton"), "main");
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition Body =
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 16)
                .addBox(-4.0F, -4.0F, -2.0F, 8.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)),
    ...
    PartDefinition waist =
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(32, 0)
                .addBox(-4.0F, -1.0F, -2.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
    ...
    PartDefinition lefthand =
        partdefinition.addOrReplaceChild(
            "lefthand",
            CubeListBuilder.create()
                .texOffs(24, 16)
                .addBox(-1.0F, -1.0F, -1.0F, 2.0F, 22.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offset(5.0F, -2.0F, 0.0F));

    PartDefinition righthand =
        partdefinition.addOrReplaceChild(
            "righthand",
            CubeListBuilder.create()
                .texOffs(0, 29)
    ...
    PartDefinition stick =
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(8, 29)
                .addBox(-1.0F, -11.0F, -1.0F, 2.0F, 16.0F, 2.0F, new CubeDeformation(0.0F)),
  ...
  public void setupAnim(@Nonnull T entity) {
    ...
    if (entity.attackAnimationState.isStarted()) {
      this.animate(
          entity.attackAnimationState, CursedSkeletonAnimations.ATTACK, entity.ageInTicks, 1.0F);
    } else if (entity.idleAnimationState.isStarted()) {
      this.animate(
          entity.idleAnimationState, CursedSkeletonAnimations.IDLE, entity.ageInTicks, 1.0F);
    }

    this.animateWalk(
        CursedSkeletonAnimations.WALK,
