...
import static org.loaders.soul_morphing.init.SoulItems.EBOBA;
...
public class SinnerHeavySphereEntity extends AbstractArrow implements ItemSupplier {
  ...
  public static final ItemStack PROJECTILE_ITEM = new ItemStack(EBOBA);
  ...
  public SinnerHeavySphereEntity(
      EntityType<? extends SinnerHeavySphereEntity> type,
      LivingEntity entity,
      Level world,
  ...
  public static SinnerHeavySphereEntity shoot(
      Level world, LivingEntity entity, RandomSource source) {
    return shoot(world, entity, source, 1f, 5, 5);
  }

  public static SinnerHeavySphereEntity shoot(
      Level world, LivingEntity entity, RandomSource source, float pullingPower) {
  ...
  public static SinnerHeavySphereEntity shoot(
      ...
      double damage,
      int knockback) {
    SinnerHeavySphereEntity entityarrow =
        new SinnerHeavySphereEntity(SoulEntities.SINNER_HEAVY_SHPERE.get(), entity, world, null);
    entityarrow.shoot(
  ...
  public static SinnerHeavySphereEntity shoot(LivingEntity entity, LivingEntity target) {
    SinnerHeavySphereEntity entityarrow =
        new SinnerHeavySphereEntity(
            SoulEntities.SINNER_HEAVY_SHPERE.get(), entity, entity.level(), null);
