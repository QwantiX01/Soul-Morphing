...
public class SpiritHoundRenderer extends MobRenderer<SpiritHoundEntity, SpiritHoundRenderState, SpiritHoundModel<SpiritHoundRenderState>> {


    public SpiritHoundRenderer(EntityRendererProvider.Context context, SpiritHoundModel<SpiritHoundRenderState> model, float p_174306_) {
        super(context, new SpiritHoundModel<>(context.bakeLayer(SpiritHoundModel.LAYER_LOCATION)), p_174306_);
    }

    @Override
    public ResourceLocation getTextureLocation(SpiritHoundRenderState SpiritHoundRenderState) {
    ...
    public void extractRenderState(SpiritHoundEntity SpiritHoundEntity, SpiritHoundRenderState renderState, float v) {
