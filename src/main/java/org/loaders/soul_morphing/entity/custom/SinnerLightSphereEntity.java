...
public class SinnerLightSphereEntity extends AbstractArrow implements ItemSupplier {
    ...
    public SinnerLightSphereEntity(EntityType<? extends SinnerLightSphereEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
        super(type, entity, world, PROJECTILE_ITEM, firedFromWeapon);
    }

    public static SinnerLightSphereEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
        SinnerLightSphereEntity entityarrow = new SinnerLightSphereEntity(SoulEntities.SINNER_LIGHT_SHPERE.get(), entity, world, null);
