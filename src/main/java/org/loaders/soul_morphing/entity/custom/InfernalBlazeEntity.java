...
public class InfernalBlazeEntity extends Monster {
  public final AnimationState IDLE_ANIMATION_STATE = new AnimationState();
  public final AnimationState WALK_ANIMATION_STATE = new AnimationState();
  public final AnimationState ATTACK_ANIMATION_STATE = new AnimationState();
  public static int animationTimeout = 0;

  public InfernalBlazeEntity(EntityType<? extends Monster> entityType, Level level) {
  ...
  public void setupAnimations() {
    ...
    if (walkAnimation.isMoving()) {
      ...
      WALK_ANIMATION_STATE.start(this.tickCount);
    } else {
  ...
  protected void registerGoals() {
    ...
    this.targetSelector.addGoal(
        3, new NearestAttackableTargetGoal<>(this, AbstractVillager.class, false));
  }
}
