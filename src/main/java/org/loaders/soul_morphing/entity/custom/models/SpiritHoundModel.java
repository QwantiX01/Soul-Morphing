...
public class SpiritHoundModel<T extends SpiritHoundRenderState> extends EntityModel<T> {
  ...
  public static final ModelLayerLocation LAYER_LOCATION =
      new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MODID, "spirit_hound"), "main");
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition head =
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(36, 34)
                .addBox(-4.0F, -1.0F, -12.0F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0)
                .addBox(-5.0F, -6.0F, -6.0F, 10.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 5.0F, -4.0F));

    PartDefinition Lhorn =
        head.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                ...
                .texOffs(24, 47)
                .addBox(1.0F, -4.0F, 2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 56)
                .addBox(0.0F, -3.0F, 0.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(24, 53)
                .addBox(-2.0F, -1.0F, -1.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
            PartPose.offset(5.0F, -7.0F, -2.0F));

    PartDefinition Lhorn2 =
        head.addOrReplaceChild(
            "Lhorn2",
            CubeListBuilder.create()
                .texOffs(18, 59)
                .addBox(-3.0F, -5.0F, 4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(60, 44)
                .addBox(-3.0F, -4.0F, 2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(62, 0)
                .addBox(-3.0F, -3.0F, 0.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(44, 53)
                .addBox(-2.0F, -1.0F, -1.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
            PartPose.offset(-5.0F, -7.0F, -2.0F));
    ...
    PartDefinition body =
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 17)
                .addBox(-2.0F, -1.2954F, -0.5837F, 4.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)),
    ...
    PartDefinition Larm =
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(36, 44)
                .addBox(-3.0F, -2.0F, -5.0F, 7.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)),
    ...
    PartDefinition Larm2 =
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 47)
                .addBox(-5.0F, -2.0F, -3.0F, 7.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)),
            PartPose.offset(-8.0F, 12.0F, -2.0F));

    PartDefinition particles =
        partdefinition.addOrReplaceChild(
            "particles",
            CubeListBuilder.create()
                .texOffs(12, 41)
                .addBox(-14.0F, -6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(49, 12)
                .addBox(12.0F, -5.0F, -8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(39, 28)
  ...
  public void setupAnim(@Nonnull T entity) {
    ...
    if (entity.attackAnimationState.isStarted()) {
      this.animate(
          ...
          SpiritHoundAnimations.attackAnimation,
          entity.ageInTicks,
          1.0F);
    } else if (entity.idleAnimationState.isStarted()) {
      this.animate(
          entity.idleAnimationState, SpiritHoundAnimations.idleAnimation, entity.ageInTicks, 1.0F);
    }

    this.animateWalk(
        SpiritHoundAnimations.walkAnimation,
