...
public class SoulEntities {
    ...
    public static final Supplier<EntityType<? extends IgniteSpiritEntity>> IGNITE_SPIRIT_ENTITY =
            ENTITY_TYPES.register("ignite_spirit", () -> EntityType.Builder
                    ...
                    .sized(0.6F, 2.25F)
                    .build(ResourceKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "ignite_spirit"))));

    public static final Supplier<EntityType<? extends DeevourerEntity>> DEVOURER =
            ENTITY_TYPES.register("deevourer", () -> EntityType.Builder
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SinnerLightSphereEntity>> SINNER_LIGHT_SHPERE = register(
            "sinner_light_shpere",
            EntityType.Builder.<SinnerLightSphereEntity>of(SinnerLightSphereEntity::new, MobCategory.MISC)
                    .setShouldReceiveVelocityUpdates(true)
                    .setTrackingRange(64)
                    .setUpdateInterval(1)
                    .sized(0.5f, 0.5f));

    public static final DeferredHolder<EntityType<?>, EntityType<SinnerHeavySphereEntity>> SINNER_HEAVY_SHPERE = register(
            "sinner_heavy_shpere",
            EntityType.Builder.<SinnerHeavySphereEntity>of(SinnerHeavySphereEntity::new, MobCategory.MISC)
                    .setShouldReceiveVelocityUpdates(true)
                    .setTrackingRange(64)
                    .setUpdateInterval(1)
                    .sized(3f, 3f));
    ...
    public static final Supplier<EntityType<? extends SpiritHoundEntity>> SPIRIT_HOUND =
            ENTITY_TYPES.register("spirit_hound", () -> EntityType.Builder
                    .of(SpiritHoundEntity::new, MobCategory.MONSTER)
                    .sized(0.6F, 2.25F)
                    .build(ResourceKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(MODID, "spirit_hound"))));
